...
function showForm() {
    // Form does not reset here
    // These two console.logs return the same value
    console.log(form)
    form.reset()
    console.log(form)
...
<template>
    ...
    <button type="button" @click="showForm">
        {{ formIsShown ? 'Hide form' : 'Show form' }}
    </button>

    <div v-if="formIsShown">
        <h1 class="text-3xl">Form</h1>

        <form @submit.prevent="submitForm" class="mt-6 max-w-md space-y-4">
